...
<div class="container-fluid">
   ...
   <div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <form action="{{route('hostel.update')}}" method="POST" class=row data-parsley-validate=""  enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" value="{{$edit_data->id}}" name="hidden_id">
                    <input type="hidden" value="{{ $edit_data->customer_type ?? 'hostel' }}" name="customer_type">
                    <div class="col-sm-6">
              ...
              <!-- =========== -->
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="form-group">
                            ...
                            <label class="switch">
                              <input type="checkbox" value="active" name="status" @if($edit_data->status==1)checked @endif>
