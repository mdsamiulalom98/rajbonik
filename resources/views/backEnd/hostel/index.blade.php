        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <a href="{{route('hostel.create')}}" class="btn btn-primary rounded-pill">Create</a>
                </div>
                                ...
                                <tbody>
                                    @foreach ($show_data as $key => $value)
                                        <tr>
                                            ...
                                            <td>{{ $value->name }}</td>
                                            <td>{{ $value->phone }}</td>
                                            <td>{{ $value->district ? $value->district->name : '' }},{{ $value->thana ? $value->thana->name : '' }}
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="button-list">
                                                    @if ($value->status == 1)
                                                        <form method="post" action="{{ route('hostel.inactive') }}"
                                                            class="d-inline">
                                                            @csrf
                                                    ...
                                                    @else
                                                        <form method="post" action="{{ route('hostel.active') }}"
                                                            class="d-inline">
                                                            @csrf
                                                            <input type="hidden" value="{{ $value->id }}"
                                                                name="hidden_id">
                                                    ...
                                                    <a href="{{ route('hostel.edit', $value->id) }}"
                                                        class="btn btn-xs btn-primary waves-effect waves-light"><i
                                                            class="fe-edit-1"></i></a>

                                                    <a href="{{ route('hostel.profile', ['id' => $value->id]) }}"
                                                        class="btn btn-xs btn-blue waves-effect waves-light"><i
                                                            class="fe-eye"></i></a>

                                                    <form method="post" action="{{ route('hostel.adminlog') }}"
