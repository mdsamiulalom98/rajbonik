            ...
            <div class="h-100" data-simplebar>
                ...
                <div id="sidebar-menu">
                    ...
                    <ul id="side-menu">
                        ...
                        <!-- nav items -->
                          <li>
                            <a href="#sidebar-hostel" data-bs-toggle="collapse">
                                <i data-feather="user-plus"></i>
                                <span> Hostels </span>
                                <span class="menu-arrow"></span>
                            </a>
                            <div class="collapse" id="sidebar-hostel">
                                <ul class="nav-second-level">
                                    <li>
                                        <a href="{{route('hostel.create')}}"><i data-feather="minus"></i> Add Hostel</a>
                                    </li>
                                    <li>
                                        <a href="{{route('hostel.index',['status'=>'pending'])}}"><i data-feather="minus"></i> Pending Hostel</a>
                                    </li>
                                    <li>
                                        <a href="{{route('hostel.index',['status'=>'active'])}}"><i data-feather="minus"></i> All Hostel</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        <!--nav items-->
                        <li>
                            <a href="#sidebar-hostel-order" data-bs-toggle="collapse">
                                <i data-feather="shopping-cart"></i>
                                <span> Hostels Orders</span>
                                <span class="menu-arrow"></span>
                            </a>
                            <div class="collapse" id="sidebar-hostel-order">
                                <ul class="nav-second-level">
                                    <li>
                                        <a href="{{ route('admin.hostelorders', ['slug' => 'all']) }}"><i
                                                data-feather="minus"></i> All Order</a>
                                    </li>
                                    @foreach ($orderstatus as $value)
                                        <li>
                                            <a href="{{ route('admin.hostelorders', ['slug' => $value->slug]) }}"><i
