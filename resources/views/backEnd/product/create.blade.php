                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('products.store') }}" method="POST" class="row" data-parsley-validate=""
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text"
                                                class="nrequired form-control @error('wholesale_price') is-invalid @enderror"
                            ...
                            <div class="col-sm-2 mb-3">
                                <div class="form-group">
                                    <label for="wholesale" class="d-block">Wholesale</label>
                                    <label class="switch">
                            ...
                            <div class="col-sm-2 mb-3">
                                <div class="form-group">
                                    ...
                                    <label class="switch">
                                        <input type="checkbox" value="1" name="hostel_product" />
                                        <span class="slider round"></span>
                                    </label>
                            ...
                            <div class="col-sm-2 mb-3">
                                <div class="form-group">
                                    ...
                                    <label class="switch">
                                        <input type="checkbox" value="1" name="is_vegetable" />
                                        <span class="slider round"></span>
                                    </label>
                                    @error('is_vegetable')
                                        <span class="invalid-feedback" role="alert">
