                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('products.update') }}" method="POST" class="row" data-parsley-validate=""
                                ...
                                <div class="variable_product">
                                    ...
                                    @foreach ($variables as $variable)
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-sm-2">
                                                <div class="form-group">
                                                    <label for="up_wholesale_prices" class="form-label">Wholesale Price
                                                        *</label>
                                                    <input type="text"
                                                        class="form-control @error('up_wholesale_prices') is-invalid @enderror"
                                                        name="up_wholesale_prices[]"
                                                        value="{{ $variable->purchase_price }}"
                                                        id="up_wholesale_prices" />
                                                    @error('up_wholesale_prices')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                                    @enderror
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-sm-2">
                                            <div class="form-group">
                                                <label for="wholesale_prices" class="form-label">Wholesale Price *</label>
                                                <input type="text"
                                                    class="form-control @error('wholesale_prices') is-invalid @enderror"
                                                    name="wholesale_prices[]" value="{{ old('wholesale_prices') }}"
                                                    id="wholesale_prices" />
                                    ...
                                    <div class="clone_variable" style="display:none">
                                        <div class="row increment_control">
                                            ...
                                            <div class="col-sm-2">
                                                <div class="form-group">
                                                    <label for="wholesale_prices" class="form-label">Wholesale Price
                                                        *</label>
                                                    <input type="text"
                                                        class="form-control @error('wholesale_prices') is-invalid @enderror"
                                                        name="wholesale_prices[]" value="{{ old('wholesale_prices') }}"
                            ...
                            <div class="col-sm-2 mb-3">
                                <div class="form-group">
                                    <label for="wholesale" class="d-block">Wholesle</label>
                                    <label class="switch">
                                        <input type="checkbox" value="1" name="wholesale"
                                            @if ($edit_data->wholesale == 1) checked @endif>
                                        <span class="slider round"></span>
                                    </label>
                                    @error('wholesale')
                                        <span class="invalid-feedback" role="alert">
                            ...
                            <div class="col-sm-2 mb-3">
                                <div class="form-group">
                                    <label for="hostel_product" class="d-block">Hostel Product</label>
                                    <label class="switch">
                                        <input type="checkbox" value="1" {{ $edit_data->hostel_product == 1 ? 'checked' : '' }} name="hostel_product" />
                                        <span class="slider round"></span>
                                    </label>
                                    @error('hostel_product')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    @enderror
                            ...
                            <div class="col-sm-2 mb-3">
                                <div class="form-group">
                                    <label for="is_vegetable" class="d-block">Vegetable Product</label>
                                    <label class="switch">
                                        <input type="checkbox" value="1" {{ $edit_data->is_vegetable == 1 ? 'checked' : '' }} name="is_vegetable" />
                                        <span class="slider round"></span>
                                    </label>
                                    @error('is_vegetable')
                                        <span class="invalid-feedback" role="alert">
