 ...
 Session::get('shipping')?Session::get('shipping'):0; $discount = Session::get('discount')?Session::get('discount'):0; @endphp
  <div class="col-sm-9">
    ...
    <div class="button__list">
         <div class="home__shopping"><a href="{{route('home')}}"><i class="fa-solid fa-arrow-left-long"></i> Contnue Shopping</a></div>
         <div class="home__shopping"><a href="{{route('home')}}"><i class="fa-solid fa-house"></i> Back to home</a></div>
     </div>
