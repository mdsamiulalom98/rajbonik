    ...
    <div class="user-panel">
        <div class="user-sidebar">
            ...
            <div class="sidebar-menu">
                <ul>
                    <li><a href="{{ route('hostel.dashboard') }}" class="{{ request()->is('dashboard') ? 'active' : '' }}"><i class="fa-solid fa-gauge"></i>  Dashboard</a></li>

                    <li><a href="{{ route('hostel.order') }}" class="{{ request()->is('hostel/order') ? 'active' : '' }}"><i class="fa-solid fa-cart-plus"></i> My Order</a></li>
            ...
            <div class="user-header">
                <div class="user-header-right d-flex">
                    <ul class="user-header-menu">
                        <li class="dropdown"><a class="notify-icon" role="button" data-bs-toggle="dropdown"><i class="fa-solid fa-bell"></i></a>
                             <ul class="dropdown-menu nofity-dropdown dropdown-menu-end">
                                <li><a href="{{ route('hostel.order') }}" class="value->status == 0 ? 'fw-bold' : ''"> All Order</a></li>
                             </ul>
                        </li>
                     ...
                     <div class="user-login-info d-flex dropdown">
                        <div class="dropdown">
                            <div class="user-quick d-flex" role="button">
                                <img src="{{ asset(Auth::guard('customer')->user()->image) }}" alt="">
                                <p>{{ Str::limit(Auth::guard('customer')->user()->shop_name, 15) }} <i class="fa-solid fa-caret-down"></i></p>
                            </div>
                            <ul class="dropdown-menu">
                                <li><a href="{{ route('hostel.hprofile') }}"><i class="fa-solid fa-home"></i> My Account</a></li>
                                <li><a href="{{ route('hostel.settings') }}"><i class="fa-solid fa-cog"></i> Setting</a></li>
                                <li><a href="{{ route('hostel.change_pass') }}"><i class="fa-solid fa-key"></i> Change Password</a></li>
                                <li>
                                    <a href="{{ route('hostel.logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form2').submit();">
                                        <i class="fa-solid fa-sign-out"></i> Logout
                                        <form id="logout-form2" action="{{ route('hostel.logout') }}" method="POST" style="display: none;">
                                            @csrf
                                        </form>
                                    </a>
                                </li>
