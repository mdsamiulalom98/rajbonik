                  ...
                  @foreach (Cart::instance('shopping')->content() as $value)
                    <tr>
                      ...
                      <td>{{$value->subtotal}}</td>
                       <td><span  class="btn btn-xs btn-info edit_hostel_order" data-id="{{$value->id}}"><i class="fa-regular fa-pen-to-square"></i></span> <span class="btn btn-xs btn-danger cart__remove" data-id="{{$value->id}}" ><i class="fa-solid fa-trash-can"></i></span></td>
                    </tr>
                  @endforeach
              </tbody>
          </table>
