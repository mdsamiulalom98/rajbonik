...
use App\Http\Controllers\Admin\HostelManageController;
...
Route::get('/migrate', function () {
    ...
    Toastr::success('Database Migrated!!');
...
Route::group(['namespace' => 'Frontend', 'middleware' => ['ipcheck', 'check_refer']], function () {
    ...
    Route::get('view/cart', [FrontendController::class, 'viewCart'])->name('viewCart');
    Route::get('view/cart/ajax', [FrontendController::class, 'viewCart_ajax'])->name('viewCart.ajax');

    Route::get('cart/list', [FrontendController::class, 'cart__list'])->name('cart__list.ajax');

    Route::get('quick-view', [FrontendController::class, 'quickview'])->name('quickview');
    Route::get('invoice-data', [HostelController::class, 'invoiceData'])->name('invoice.data');
    Route::get('order-create', [HostelController::class, 'orderCreate'])->name('order.create.hostel');

    Route::get('order-updates', [HostelController::class, 'orderUpdates'])->name('order.updates.hostel');
    ...
    Route::get('address-modal-open',[FrontEndController::class, 'address_modal'])->name('customer.address.modal');
    Route::get('address-edit-modal-open',[FrontEndController::class, 'address_modal_edit'])->name('customer.address.edit.modal');
    Route::get('address-remove',[FrontEndController::class, 'address_remove'])->name('address.remove');

    Route::get('time-slots',[FrontEndController::class, 'fetchAvailableTimes'])->name('timeslots');
    ...
    Route::get('wishlist/summary', [ShoppingController::class, 'wishlist_summary'])->name('wishlist.summary');
     Route::get('mobile/wishlist/count', [ShoppingController::class, 'mobile__wishlist'])->name('mobile.wishlist.count');
    ...
    Route::get('/add-to-cart-quick', [ShoppingController::class, 'addTocartGetQuick']);
...
Route::group(['namespace' => 'FrontEnd', 'middleware' => ['check_refer'], 'prefix' => 'hostel'], function () {
    ...
    Route::get('/verify', [HostelController::class, 'verify'])->name('hostel.verify');
    Route::post('/verify-account', [HostelController::class, 'account_verify'])->name('hostel.account.verify');
    Route::post('/resend-otp', [HostelController::class, 'resendotp'])->name('hostel.resendotp');
    Route::post('/logout', [HostelController::class, 'logout'])->name('hostel.logout');
    Route::get('/forgot-password', [HostelController::class, 'forgot_password'])->name('hostel.forgot.password');
    Route::post('/forgot-verify', [HostelController::class, 'forgot_verify'])->name('hostel.forgot.verify');
    Route::get('/forgot-password/reset', [HostelController::class, 'forgot_reset'])->name('hostel.forgot.reset');
    Route::post('/forgot-password/store', [HostelController::class, 'forgot_store'])->name('hostel.forgot.store');
    Route::post('/forgot-password/resendotp', [HostelController::class, 'forgot_resend'])->name('hostel.forgot.resendotp');
});
//hostel manage route
Route::group(['namespace' => 'FrontEnd', 'prefix' => 'hostel'], function () {
    ...
    Route::get('/payment', [HostelController::class, 'rider_payment'])->name('hostel.parcel.payment');
    Route::get('/parcel/payable', [HostelController::class, 'payable_parcel'])->name('hostel.parcel.payable');
    Route::post('/payment/request', [HostelController::class, 'payment_request'])->name('hostel.payment.request');
    Route::get('/payment/invoice/{id}', [HostelController::class, 'payment_invoice'])->name('hostel.payment.invoice');
    Route::get('/parcel/fraud-checker', [HostelController::class, 'fraud_checker'])->name('hostel.parcel.fraud_checker');
    Route::get('/merchant/notice', [HostelController::class, 'notice'])->name('hostel.notice');
    ...
    Route::get('parcel/view/{id}', [HostelController::class, 'view'])->name('hostel.parcel.view');
    Route::get('parcel/label-print/{id}', [HostelController::class, 'label_print'])->name('hostel.parcel.label_print');
});

Route::group(['prefix' => 'customer', 'namespace' => 'Frontend', 'middleware' => ['ipcheck', 'check_refer']], function () {
    Route::get('/login', [CustomerController::class, 'login'])->name('customer.login');
    Route::get('/hostel/login', [CustomerController::class, 'hostellogin'])->name('hostel.login');
...
Route::group(['prefix' => 'customer', 'namespace' => 'Frontend', 'middleware' => ['customer', 'ipcheck', 'check_refer']], function () {
    ...
    Route::post('/address-create', [CustomerController::class, 'address_create'])->name('customer.address.create');
    Route::post('/address-update', [CustomerController::class, 'address_update'])->name('customer.address.update');
});
...
Route::group(['namespace' => 'Admin', 'middleware' => ['auth', 'lock', 'check_refer'], 'prefix' => 'admin'], function () {
    ...
    // hostel manage route
    Route::get('hostel/payment/{status}', [HostelManageController::class, 'payment'])->name('riders.payment');
    Route::get('hostel/invoice/{id}', [HostelManageController::class, 'invoice'])->name('riders.invoice');
    Route::post('hostel/payment/status', [HostelManageController::class, 'payment_status'])->name('riders.payment.status');
    Route::get('hostel/create', [HostelManageController::class, 'create'])->name('hostel.create');
    Route::post('hostel/store', [HostelManageController::class, 'store'])->name('hostel.store');
    Route::get('hostel/manage', [HostelManageController::class, 'index'])->name('hostel.index');
    Route::get('hostel/{id}/edit', [HostelManageController::class, 'edit'])->name('hostel.edit');
    Route::post('hostel/update', [HostelManageController::class, 'update'])->name('hostel.update');
    Route::post('hostel/inactive', [HostelManageController::class, 'inactive'])->name('hostel.inactive');
    Route::post('hostel/active', [HostelManageController::class, 'active'])->name('hostel.active');
    Route::get('hostel/profile', [HostelManageController::class, 'profile'])->name('hostel.profile');
    Route::post('hostel/adminlog', [HostelManageController::class, 'adminlog'])->name('hostel.adminlog');
    Route::get('hostel/manual-payment', [HostelManageController::class, 'menual_payment'])->name('hostel.menual_payment');
    Route::post('hostel/manual-payment/paid', [HostelManageController::class, 'menual_payment_paid'])->name('hostel.menual_payment.paid');
    ...
    // timeslots
    Route::get('time-slot/manage', [TimeslotController::class, 'index'])->name('timeslots.index');
    Route::get('time-slot/{id}/show', [TimeslotController::class, 'show'])->name('timeslots.show');
    Route::get('time-slot/create', [TimeslotController::class, 'create'])->name('timeslots.create');
    Route::post('time-slot/save', [TimeslotController::class, 'store'])->name('timeslots.store');
    Route::get('time-slot/{id}/edit', [TimeslotController::class, 'edit'])->name('timeslots.edit');
    Route::post('time-slot/update', [TimeslotController::class, 'update'])->name('timeslots.update');
    Route::post('time-slot/inactive', [TimeslotController::class, 'inactive'])->name('timeslots.inactive');
    Route::post('time-slot/active', [TimeslotController::class, 'active'])->name('timeslots.active');
    Route::post('time-slot/destroy', [TimeslotController::class, 'destroy'])->name('timeslots.destroy');
    ...
    Route::get('orders/{slug}', [OrderController::class, 'hostelorder_index'])->name('admin.hostelorders');
    ...
    // Shipping Discount route
    Route::get('shipping-discount/manage', [ShippingDiscountController::class, 'index'])->name('shippingdiscount.index');
    Route::get('shipping-discount/create', [ShippingDiscountController::class, 'create'])->name('shippingdiscount.create');
    Route::post('shipping-discount/save', [ShippingDiscountController::class, 'store'])->name('shippingdiscount.store');
    Route::get('shipping-discount/{id}/edit', [ShippingDiscountController::class, 'edit'])->name('shippingdiscount.edit');
    Route::post('shipping-discount/update', [ShippingDiscountController::class, 'update'])->name('shippingdiscount.update');
    Route::post('shipping-discount/inactive', [ShippingDiscountController::class, 'inactive'])->name('shippingdiscount.inactive');
    Route::post('shipping-discount/active', [ShippingDiscountController::class, 'active'])->name('shippingdiscount.active');
    Route::post('shipping-discount/destroy', [ShippingDiscountController::class, 'destroy'])->name('shippingdiscount.destroy');
});
